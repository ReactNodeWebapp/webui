    ...
    return (
        <div className="hero">
            <div className="hero__left-container">
                <p className="hero__cta">EXCLUSIVE ACCESS</p>
                <p className="hero__slogan">Unlimited Transactions with zero fees</p>
                <p className="hero__summary">Get access to our exclusive diamond card which allows
            ...
            <div className="hero__right-container">
                <svg xmlns="http://www.w3.org/2000/svg" width="628" height="549" viewBox="0 0 628 549" fill="none">
                    <g clipPath="url(#clip0)">
                        <path d="M531.201 327.768C534.893 341.36 526.18 355.211 511.739 358.705L121.695 453.088C107.254 456.582 92.5538 448.395 88.8618 434.805L24.2359 196.924C20.5434 183.333 29.2567 169.483 43.6975 165.988L433.741 71.6058C448.183 68.1112 462.882 76.2969 466.574 89.8876L531.201 327.768Z" fill="white"/>
                        <path d="M475.06 121.121L32.7209 228.157L48.6275 286.708L490.966 179.671L475.06 121.121Z" fill="#286CFF"/>
                        <path d="M490.971 179.687L48.6321 286.724L58.474 322.951L500.813 215.914L490.971 179.687Z" fill="#F5F5F5"/>
                        <path opacity="0.15" d="M107.451 430.307L42.8253 192.426C39.1329 178.834 47.8479 164.984 62.2887 161.49L43.6967 165.988C29.2567 169.483 20.5439 183.334 24.2359 196.924L88.8618 434.805C92.5542 448.397 107.254 456.582 121.695 453.088L140.287 448.589C125.846 452.083 111.143 443.897 107.451 430.307Z" fill="#AAAAAA"/>
                    ...
                    <defs>
                        <clipPath id="clip0">
                            <rect width="455.105" height="431.39" fill="white" transform="matrix(0.971949 -0.235191 0.26217 0.965022 0 107.715)"/>
                        </clipPath>
                        <clipPath id="clip1">
